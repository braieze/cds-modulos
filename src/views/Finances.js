...
window.Views.Finances = ({ finances, addData, userProfile }) => {
    ...
    const { Card, Button, Badge, Modal, Input, Select, DateFilter, formatCurrency, formatDate, Icon, SmartSelect } = Utils;
    ...
    return (
        <div className="space-y-8 fade-in pb-20">
            ...
            {/* CORRECCIÓN: Usamos DateFilter y pasamos prop onChange correctamente */}
